...
def get_pipeline(
    ...
    tenant_name = ParameterString(
        name="tenant_name", default_value=""
    )
    ...
    step_retrieve_tenant = LambdaStep(
        name="LambdaStep",
        lambda_func=Lambda(
            function_arn="arn:aws:lambda:{}:{}:function:{}".format(region, account, tenant_info_lambda_name)
        ),
        inputs={
            "tenant-name": tenant_name
        },
        outputs=[
            LambdaOutput(output_name="tenant_data_location", output_type=LambdaOutputTypeEnum.String), 
            LambdaOutput(output_name="tenant_model_package_group", output_type=LambdaOutputTypeEnum.String)
        ],
    )
    ...
    step_process = ProcessingStep(
        ...
        job_arguments=["--input-data", step_retrieve_tenant.properties.Outputs['tenant_data_location']],
    )
    ...
    step_register = RegisterModel(
        ...
        model_package_group_name=step_retrieve_tenant.properties.Outputs['tenant_model_package_group'],
        approval_status=model_approval_status,
        model_metrics=model_metrics,
        customer_metadata_properties = {"tenant_name" : tenant_name}
    )
    ...
    pipeline = Pipeline(
        ...
        steps=[step_retrieve_tenant, step_process, step_train, step_eval, step_cond],
        sagemaker_session=sagemaker_session,
    )
    return pipeline
